...
for (i in 1:260) {
  states_final[[i]] <- data.matrix(states_final[[i]]) * twitter_state$`Twitter: (12/1/13 - 12/1/18)`
  print(i)
}
for (i in 1:49) {
  states_final[i, ] <- data.matrix(states_final[i, ]) * twitter_trend$`Twitter: (United States)` / 10000
  print(i)
}
for (i in 1:260) {
